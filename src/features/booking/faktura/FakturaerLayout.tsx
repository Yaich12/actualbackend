...
const fakturaLinks = [
  { label: "Daglig Salgsoverblik", href: "/booking/fakturaer", end: true },
  { label: "Aftaler", href: "/booking/fakturaer/aftaler" },
  { label: "Salg", href: "/booking/fakturaer/salg" },
  { label: "Betalinger", href: "/booking/fakturaer/betalinger" },
];
        ...
        <div className="booking-content">
          <aside className="flex h-full w-64 flex-shrink-0 flex-col border-r border-slate-200 bg-white">
            <div className="px-6 pb-4 pt-6">
              ...
              <h2 className="mt-2 text-xl font-semibold text-slate-900">Salg</h2>
            </div>
