export const TRANSLATIONS = {
  da: {
    ...
    pricing: {
      ...
      secondaryCta: "Klik for salg",
      plans: {
        starter: {
          name: "Starter",
          description:
            "God til små virksomheder og startups, der vil i gang med AI.",
          buttonText: "Kom i gang",
          includes: [
            "Gratis inkluderet:",
            "Ubegrænsede kort",
            "Tilpasset baggrund og stickers",
            "Tofaktorgodkendelse",
            "Op til 2 individuelle brugere",
            "Op til 2 workspaces",
          ],
        },
        business: {
          name: "Business",
          description:
            "Bedste værdi for voksende virksomheder, der har brug for flere funktioner.",
          buttonText: "Kom i gang",
          includes: [
            "Alt i Starter, plus:",
            "Avancerede tjeklister",
            "Tilpassede felter",
            "Serverless-funktioner",
            "Op til 10 individuelle brugere",
            "Op til 10 workspaces",
          ],
        },
        enterprise: {
          name: "Enterprise",
          description:
            "Avanceret plan med øget sikkerhed og ubegrænset adgang for store teams.",
          buttonText: "Kom i gang",
          includes: [
            "Alt i Business, plus:",
            "Styring af flere boards",
            "Gæsteadgang til flere boards",
            "Tilladelser til vedhæftninger",
            "Tilpassede roller",
            "Tilpassede boards",
          ],
        },
