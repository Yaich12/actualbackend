...
export const TRANSLATIONS = {
  da: {
    ...
    landing: {
      ...
      globeFeature: {
        titlePrefix: "Byg med",
        subtitle:
          "Støt kliniske teams med sikker transkription og AI-assisteret dokumentation - skabt til at forbedre konsistens, reducere administration og skalere på tværs af moderne klinikker.",
        cta: "Bliv medlem i dag",
      },
      statsSection: {
        ...
        columns: {
          product: {
            ...
            items: {
              daily: "Daglig drift",
              monitoring: "Overblik",
              mentor: "Selma Copilot",
              clinicalBuddy: "FactsR",
              timeCreator: "Booking",
              events: "Events",
            },
          },
    ...
    pricing: {
      title: "Vi har en plan, der passer til dig",
      description:
        "Betroet af millioner. Vi hjælper teams verden over med at finde den rigtige plan.",
      switch: {
      ...
      plans: {
        starter: {
          name: "Solo plan",
          description: "Til solo-behandleren der vil have en komplet løsning.",
          buttonText: "Kom i gang",
          includes: [
            "Gratis inkluderet:",
            "Online booking-side til dine patienter",
            "Kalender-synk + booking-overblik",
            "Ubegrænset antal patienter og ydelser",
            "Transkribering af alle konsultationstyper (inkl. 10+ skabeloner)",
            "Diktering til journal/noter efter behov (inkl. 10+ skabeloner)",
            "Selma+ assistent indbygget i dine notater (5 hurtigknapper)",
            "Ingen loft på transkribering, diktering eller Selma+-sparring",
            "Eksport/overblik over noter og forløb",
          ],
        },
        business: {
          name: "Duo plan",
          description: "Til to brugere der vil arbejde i samme klinikflow.",
          buttonText: "Kom i gang",
          includes: [
            "Alt i Solo, plus:",
            "2 brugere inkluderet (perfekt til makkerklinik / behandler + admin)",
            "Delte patienter og fælles forløb (arbejd i samme patienthistorik)",
            "Team-kalender: fordel bookinger mellem jer og undgå overlap",
            "Fælles skabelon-bibliotek (del templates på tværs af jer)",
            "Fælles ydelser/priser/opsætning på tværs af brugere",
            "Prioriteret support",
          ],
        },
        enterprise: {
          name: "Enterprise",
          description: "Til større klinikker med behov for avanceret opsætning og styring.",
          buttonText: "Kontakt os",
          includes: [
            "Alt i Duo, plus:",
            "Ubegrænset antal brugere og teams",
            "Flere lokationer/afdelinger + central styring",
            "Avancerede roller og rettigheder",
            "Tilpassede workflows, templates og felter",
            "Integrationer/API (journal/BI/betaling m.m.)",
          ],
        },
      },
    },
    ...
    login: {
      ...
      description:
        "Log ind med email og kode eller fortsæt med Google. Du kan stadig bruge din magiske link-login, hvis du har et aktivt email-link.",
      form: {
        emailLabel: "Email",
  ...
  en: {
    ...
    landing: {
      ...
      globeFeature: {
        titlePrefix: "Build with",
        subtitle:
          "Support clinical teams with secure transcription and AI-assisted documentation - designed to improve consistency, reduce administrative time, and scale across modern practice.",
        cta: "Join today",
      },
      statsSection: {
    ...
    pricing: {
      ...
      description:
        "Trusted by millions. We help teams around the world find the right plan.",
      switch: {
      ...
      plans: {
        starter: {
          name: "Solo plan",
          description: "For the solo clinician who wants a complete solution.",
          buttonText: "Get started",
          includes: [
            "Free included:",
            "Online booking page for your patients",
            "Calendar sync + booking overview",
            "Unlimited patients and services",
            "Transcription for all consultation types (incl. 10+ templates)",
            "Dictation for journals/notes as needed (incl. 10+ templates)",
            "Selma+ assistant built into your notes (5 quick buttons)",
            "No limits on transcription, dictation, or Selma+ sparring",
            "Export/overview of notes and care paths",
          ],
        },
        business: {
          name: "Duo plan",
          description: "For two users who want to work in the same clinic flow.",
          buttonText: "Get started",
          includes: [
            "Everything in Solo, plus:",
            "2 users included (perfect for partner clinic / clinician + admin)",
            "Shared patients and joint care paths (work in the same patient history)",
            "Team calendar: distribute bookings between you and avoid overlaps",
            "Shared template library (share templates across you)",
            "Shared services/prices/setup across users",
            "Priority support",
          ],
        },
        enterprise: {
          name: "Enterprise",
          description: "For larger clinics that need advanced setup and control.",
          buttonText: "Contact us",
          includes: [
            "Everything in Duo, plus:",
            "Unlimited users and teams",
            "Multiple locations/departments + centralized management",
            "Advanced roles and permissions",
            "Customized workflows, templates, and fields",
            "Integrations/API (EHR/BI/payments, etc.)",
          ],
        },
      },
    },
    ...
    login: {
      title: "Welcome back",
      description:
        "Sign in with email and password or continue with Google. You can still use your magic link if you have an active email link.",
      form: {
        emailLabel: "Email",
